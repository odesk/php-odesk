...
class ClientTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testNewClient()
    {
        ...
        $this->assertInstanceOf('oDesk\API\AuthTypes\OAuth1', $server);
    }
    ...
    public function testRequest()
    {
        ...
        $response = $method->invoke($helper, 'GET', 'http://www.odesk.com/api/auth/v1/info', array());
    ...
    public function testRunMethod()
    {
        ...
        $stub = $this->getMock('oDesk\API\Client', array('_request'), array($config));
        $stub->expects($this->any())
             ->method('_request')
             ->will($this->returnValue('response'));
